      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden md:flex items-center gap-4">
            {showChainSelector && (
              <ChainSelector
                selectedChain={state.currentChain}
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent
              side="right"
              className="w-[300px] sm:w-[400px] p-4 bg-white rounded-lg shadow-lg"
            >
                ...
                {auth.currentUser ? (
                  <>
                    <Link href="/profile">
                      <Button
                        variant="link"
                        className="text-gray-900 hover:text-blue-500 flex items-center gap-2"
                      >
          ...
          <SelectItem key={chain.id} value={chain.id.toString()}>
            <div className="flex items-center gap-2">
              ...
              <span className="flex items-center gap-2">
                <Coins className={`${chain.color} h-4 w-4`} /> {chain.name}
              </span>
            </div>
          </SelectItem>
        ))}
